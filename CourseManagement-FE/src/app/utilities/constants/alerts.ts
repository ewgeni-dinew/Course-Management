export class AlertConsts {
    ...
    public static TYPE_INFO: string = "info";
    ...
    public static REMOVE_FAV_COURSE_SUCCESS: string = "Course has been removed from favorites.";
    public static ADD_FAV_COURSE_SUCCESS: string = "Course has been added to favorites.";
    public static RATE_COURSE_SUCCESS: string = "Course has been rated successfully.";
}